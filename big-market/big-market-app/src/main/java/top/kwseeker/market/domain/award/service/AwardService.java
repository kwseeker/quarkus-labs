...
import top.kwseeker.market.domain.award.model.valobj.TaskStateVO;
...
public class AwardService implements IAwardService {
    ...
    public AwardService(IAwardRepository awardRepository, SendAwardMessageEvent sendAwardMessageEvent) {
        this.awardRepository = awardRepository;
        this.sendAwardMessageEvent = sendAwardMessageEvent;
        this.distributeAwardMap = CDIBeanSelector.selectMap(IDistributeAward.class);
    }
