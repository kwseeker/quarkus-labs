package top.kwseeker.market.domain.activity.service.quota.rule.factory;

import jakarta.enterprise.context.ApplicationScoped;
import lombok.AllArgsConstructor;
import lombok.Getter;
import top.kwseeker.market.domain.activity.service.quota.rule.IActionChain;
...
public class DefaultActivityChainFactory {
     ...
     * Quarkus 不支持 Map 注入
     */
    public DefaultActivityChainFactory() {
        Map<String, IActionChain> actionChainGroup = CDIBeanSelector.selectMap(IActionChain.class);
